...
(function($PS) {
  ...
  var generateObjects = Data_Array.concat([ [ {
      position: {
...
(function($PS) {
  ...
  var Data_Maybe = $PS["Data.Maybe"];
  var Data_Ord = $PS["Data.Ord"];                
  var verticalOverlap = function (left) {
      return function (right) {
          return left.position.y + left.position.height > right.position.y;
      };
  };
  ...
  var overlappingSegments = function (o) {
      return Control_Bind.bind(Control_Bind.bindArray)(segmentBy(horizontalOverlap)(sortByX(Data_Ord.ordNumber)(o)))(function (o1) {
...
(function($PS) {
  ...
  var moveObjects = function (keys) {
      return function (o) {
          ...
          throw new Error("Failed pattern match at Main.Step (line 39, column 22 - line 41, column 15): " + [ v.constructor.name ]);
      };
  };
  ...
  var handleCollision = function (v) {
      return function (v1) {
          ...
          throw new Error("Failed pattern match at Main.Step (line 115, column 1 - line 115, column 93): " + [ v.constructor.name, v1.constructor.name ]);
      };
  };
  var handleCollisions = function ($22) {
  ...
  var updateObjects = function (keys) {
      var $23 = moveObjects(keys);
      var $24 = NoControl_Engine_Collisions.handleObjectCollisions(handleCollisions);
      var $25 = Data_Functor.map(Data_Functor.functorArray)(NoControl_Engine_Step.updateObject);
      return function ($26) {
          return $23($24($25($26)));
      };
  };
  var step = function (gameMap) {
      return function (keys) {
          ...
          return {
              cameraPosition: NoControl_Engine_Render.cameraFollowObject(player)(gameMap.cameraPosition),
