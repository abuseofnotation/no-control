...
(function($PS) {
  ...
  var seedHelper = function (prevValue) {
      return function (i) {
          var seed = Data_Tuple.snd(prevValue);
          var newSeed = Random_LCG.mkSeed(Random_LCG.unSeed(seed) + i | 0);
          return new Data_Tuple.Tuple(i, Random_LCG.lcgNext(newSeed));
      };
  };
  var seedRange = function (begin) {
      return function (end) {
          return function (s) {
              return Data_Array.scanl(seedHelper)(new Data_Tuple.Tuple(0, s))(Data_Array.range(begin)(end));
          };
      };
  };
  var randomInt = function (max) {
      return function (seed) {
          return Data_EuclideanRing.mod(Data_EuclideanRing.euclideanRingInt)(Random_LCG.unSeed(seed))(max) + 1 | 0;
      };
  };
  var randomBool = function (chance) {
      return function (seed) {
          return randomInt(chance)(seed) === chance;
      };
  };
  ...
  var generateFloor = function (fn) {
      return function (towerNumber) {
          return function (v) {
              var y = Data_Int.toNumber(v.value0) * towerFloorHeight;
  ...
  var generateTower = function (fn) {
      return function (v) {
          return Control_Bind.bind(Control_Bind.bindArray)(seedRange(0)(towerFloors)(v.value1))(generateFloor(fn)(v.value0));
      };
  };
...
(function($PS) {
      ...
      return function (segments) {
          return function (object) {
              ...
              if (v instanceof Data_Maybe.Just) {
                  var $2 = f.ending(v.value0) > f.beginning(object);
                  if ($2) {
                      var $3 = f.ending(v.value0) > f.ending(object);
                      if ($3) {
  ...
  var notColliding = function (h) {
      return function (a) {
          return function (b) {
              return h.ending(a) < h.beginning(b) || h.ending(b) < h.beginning(a);
          };
      };
  };
  var horizontal = {
      ...
      ending: function (o) {
          return o.position.x + o.position.width;
      }
  };
  ...
  var checkIfReallyColliding = function (f) {
      return function (a) {
          return function (b) {
              var $5 = notColliding(horizontal)(a)(b) || notColliding(vertical)(a)(b);
              if ($5) {
                  return b;
              };
              return f(a)(b);
...
(function($PS) {
  ...
  var movePlayer = function (keys) {
      return function (a) {
          ...
          return {
              ...
              energy: {
                  x: (function () {
                      var $5 = Data_Set.member(Data_Ord.ordString)("ArrowRight")(keys);
                      if ($5) {
                          return a.energy.x + speed;
                      };
                      var $6 = Data_Set.member(Data_Ord.ordString)("ArrowLeft")(keys);
                      if ($6) {
                          return a.energy.x - speed;
                      };
                      return a.energy.x;
                  ...
                  y: (function () {
                      var $7 = Data_Set.member(Data_Ord.ordString)("ArrowUp")(keys) && onGround;
                      if ($7) {
  ...
  var moveObjects = function (keys) {
      return function (o) {
          ...
          throw new Error("Failed pattern match at Main.Step (line 77, column 22 - line 79, column 15): " + [ v.constructor.name ]);
      };
  };
  var respawnPlayerIfNeeded = function (o) {
      ...
      throw new Error("Failed pattern match at Main.Step (line 46, column 27 - line 48, column 50): " + [ p.constructor.name ]);
  };
  ...
  var dropBombsIfNeeded = function (o) {
      ...
      var $14 = Data_Array.length(currentBombs) < bombs;
      if ($14) {
  ...
  var updateObjects = function (player) {
      return function (keys) {
          ...
          var $33 = NoControl_Engine_Collisions.handleObjectCollisions(handleCollision);
...
(function($PS) {
  ...
  var main = function __do() {
      ...
      var gameMap = Main_Level.generateMap(seed);
      ...
      throw new Error("Failed pattern match at Main (line 21, column 3 - line 32, column 16): " + [ canvas.constructor.name ]);
  };
  exports["main"] = main;
})(PS);
PS["Main"].main();