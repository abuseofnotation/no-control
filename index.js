...
(function($PS) {
  ...
  var renderFrame = function (gameMap1) {
      return function (ctx) {
          return function __do() {
              var a = Data_Traversable.traverse(Data_Traversable.traversableArray)(Effect.applicativeEffect)(function (object) {
                  return Graphics_Canvas.fillPath(ctx)(Graphics_Canvas.rect(ctx)(object.position));
              })(gameMap1.objects)();
              return Effect_Console.info("foo")();
          };
      };
  };
  var height = 600.0;
  ...
  var init = function (canvas) {
      return function __do() {
          ...
          var mapState = Effect_Ref["new"](gameMap)();
          Effect_Timer.setInterval(100)(function __do() {
              var oldMap = Effect_Ref.read(mapState)();
              var newMap = step(oldMap)(ctx)();
  ...
  var processCanvas = function (v) {
      if (v instanceof Data_Maybe.Just) {
          return init(v.value0);
      };
      if (v instanceof Data_Maybe.Nothing) {
          return Effect_Console.log("No canvas");
      };
      throw new Error("Failed pattern match at Main (line 87, column 1 - line 87, column 52): " + [ v.constructor.name ]);
  };
  var main = Control_Bind.bind(Effect.bindEffect)(Graphics_Canvas.getCanvasElementById("app"))(processCanvas);
  exports["gameMap"] = gameMap;
  exports["renderFrame"] = renderFrame;
  exports["main"] = main;
  exports["width"] = width;
  exports["height"] = height;
  exports["processCanvas"] = processCanvas;
  exports["step"] = step;
