...
(function($PS) {
  ...
  var groundZero = towerFloorHeight * Data_Int.toNumber(towerFloors + 1 | 0);
  ...
  var decor = function (position) {
      return [ emptyObject(Data_Unit.unit)({
          x: position.x,
          y: position.y,
          width: position.width,
          height: 10.0
      })("slategrey"), emptyObject(Data_Unit.unit)({
          x: position.x,
  ...
  var background = function (position) {
      return [ emptyObject(Data_Unit.unit)(position)("palegoldenrod") ];
  };
  var generateMap = {
      cameraPosition: {
          width: 1000.0,
...
(function($PS) {
  ...
  var sortByType = Data_Array.sortWith(Data_Ord.ordInt)(function (o) {
      ...
      throw new Error("Failed pattern match at Main.Step (line 129, column 13 - line 133, column 18): " + [ o.type.constructor.name ]);
  });
  var jumpPower = 15.0;
  ...
  var movePlayer = function (keys) {
      return function (a) {
          ...
          return {
              ...
              energy: {
                  x: (function () {
                      var $7 = Data_Set.member(Data_Ord.ordString)("ArrowRight")(keys);
                      if ($7) {
                          return a.energy.x + speed;
                      };
                      var $8 = Data_Set.member(Data_Ord.ordString)("ArrowLeft")(keys);
                      if ($8) {
                          return a.energy.x - speed;
                      };
                      return a.energy.x;
                  ...
                  y: (function () {
                      var $9 = Data_Set.member(Data_Ord.ordString)("ArrowUp")(keys) && onGround;
                      if ($9) {
  ...
  var moveObjects = function (keys) {
      return function (o) {
          ...
          throw new Error("Failed pattern match at Main.Step (line 66, column 22 - line 68, column 15): " + [ v.constructor.name ]);
      };
  };
  var respawnPlayerIfNeeded = function (o) {
      return function (v) {
          if (v instanceof Data_Maybe.Just) {
              var playerIndex = Data_Maybe.fromMaybe(-1 | 0)(Data_Array.findIndex(isPlayer)(o));
              var $15 = v.value0.position.y > 10000.0;
              if ($15) {
                  return Data_Maybe.fromMaybe(o)(Data_Array.modifyAt(playerIndex)(function (v1) {
                      return Main_Level.playerInitialState;
                  })(o));
              };
              return o;
          };
          ...
          throw new Error("Failed pattern match at Main.Step (line 37, column 1 - line 43, column 54): " + [ o.constructor.name, v.constructor.name ]);
      };
  };
  var cameraFollowPlayer = function (player) {
      ...
      return function ($30) {
          return (function (camera) {
              var $17 = camera.y + camera.height > Main_Level.groundZero;
              if ($17) {
                  return {
                      x: camera.x,
  ...
  var handleCollision = function (v) {
      return function (v1) {
          ...
          throw new Error("Failed pattern match at Main.Step (line 142, column 1 - line 142, column 93): " + [ v.constructor.name, v1.constructor.name ]);
      };
  };
  ...
  var updateObjects = function (keys) {
  ...
  var step = function (gameMap) {
      return function (keys) {
          ...
          var objects = updateObjects(keys)(gameMap.objects);
          return {
...
(function($PS) {
  ...
  var main = function __do() {
      ...
      throw new Error("Failed pattern match at Main (line 29, column 3 - line 40, column 16): " + [ canvas.constructor.name ]);
  };
